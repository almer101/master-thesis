...
\addplot[color=orange] table {gbm1.dat};
\addplot[color=magenta] table {gbm2.dat};
\addplot[color=cyan] table {gbm3.dat};
\addplot[color=olive] table {gbm4.dat};
\end{axis}
\end{tikzpicture}
