...
\noindent The behaviours we have just described can be summed up in the next figure which depicts the surface of the option price depending on the spot price and time left to maturity. One can clearly see that the surface is slightly leaning towards the value of the payoff when time to maturity approaches $0$.
